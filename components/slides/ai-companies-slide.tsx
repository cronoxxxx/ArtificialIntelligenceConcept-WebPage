export function AICompaniesSlide() {
  return (
    <div className="h-full w-full flex items-center justify-center p-12 bg-gradient-to-br from-background via-secondary/5 to-background">
      <div className="max-w-6xl w-full">
        <h2 className="text-4xl font-bold mb-4 text-center">The AI Company Race</h2>
        ...
        <div className="flex items-center justify-center gap-8 mb-8 flex-wrap">
          ...
          <div className="flex flex-col items-center gap-2">
            <img src="/meta-logo-blue-m-symbol.jpg" alt="Meta" className="w-20 h-20 rounded-xl shadow-lg object-cover" />
            <span className="text-sm font-semibold">Meta</span>
            <span className="text-xs text-muted-foreground">Llama</span>
          </div>

          <div className="flex flex-col items-center gap-2">
            <img src="/xai-logo-black-x-minimalist.jpg" alt="xAI" className="w-20 h-20 rounded-xl shadow-lg object-cover" />
        ...
        <div className="bg-gradient-to-br from-accent/10 to-primary/10 border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-3 text-center">The Ultimate Goal: AGI</h3>
