...
export function AIRealismSlide() {
  return (
    <div className="h-full w-full flex items-center justify-center p-8 bg-gradient-to-br from-background via-purple-500/5 to-background">
      <div className="max-w-6xl w-full">
        <div className="text-center mb-6">
          <h2 className="text-4xl font-bold mb-2">AI Content: Shockingly Realistic</h2>
          <p className="text-lg text-muted-foreground">From fake to flawless in just 2 years</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-bold">Sora 2: AI Video Revolution</h3>
              </div>
