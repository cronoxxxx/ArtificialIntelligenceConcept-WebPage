export function VideoSlideChatGPT() {
  return (
      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-2xl border-4 border-primary/20">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/Y8dcyoWQQA0"
            title="ChatGPT Video"
            frameBorder="0"
        ...
        <p className="text-center text-muted-foreground mt-6 text-lg">
          Watch this video to dive deeper into how ChatGPT works and why it changed everything
        </p>
      </div>
    </div>
  )
